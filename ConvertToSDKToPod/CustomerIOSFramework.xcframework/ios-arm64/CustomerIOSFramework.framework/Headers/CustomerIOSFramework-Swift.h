...
#ifndef CUSTOMERIOSFRAMEWORK_SWIFT_H
#define CUSTOMERIOSFRAMEWORK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CustomerIOSFramework",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_PROTOCOL("_TtP20CustomerIOSFramework10AnchorView_")
@protocol AnchorView
...
SWIFT_CLASS("_TtC20CustomerIOSFramework9LoadingVC")
@interface LoadingVC : UIViewController
@property (nonatomic, copy) NSString * _Nonnull deviceId;
@property (nonatomic, copy) NSString * _Nonnull sdkAuth;
@property (nonatomic, copy) NSString * _Nonnull number;
@property (nonatomic, copy) NSString * _Nonnull mpin;
@property (nonatomic, copy) NSString * _Nonnull env;
@property (nonatomic, copy) NSString * _Nonnull priOrgId;
@property (nonatomic, copy) NSString * _Nonnull language;
@property (nonatomic, copy) NSString * _Nonnull templetType;
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC20CustomerIOSFramework14MPinDialogueVC")
@interface MPinDialogueVC : UIViewController
- (void)viewDidLoad;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface MPinDialogueVC (SWIFT_EXTENSION(CustomerIOSFramework)) <UITextFieldDelegate>
- (BOOL)textField:(UITextField * _Nonnull)textField shouldChangeCharactersInRange:(NSRange)range replacementString:(NSString * _Nonnull)string SWIFT_WARN_UNUSED_RESULT;
- (void)textFieldDidEndEditing:(UITextField * _Nonnull)textField;
@end


SWIFT_CLASS("_TtC20CustomerIOSFramework26SheetContentViewController")
...
@interface SheetContentViewController (SWIFT_EXTENSION(CustomerIOSFramework)) <UINavigationControllerDelegate>
...
SWIFT_CLASS("_TtC20CustomerIOSFramework15SheetTransition")
...
SWIFT_CLASS("_TtC20CustomerIOSFramework19SheetViewController")
...
@interface SheetViewController (SWIFT_EXTENSION(CustomerIOSFramework)) <UIViewControllerTransitioningDelegate>
...
@interface SheetViewController (SWIFT_EXTENSION(CustomerIOSFramework)) <UIGestureRecognizerDelegate>
...
SWIFT_CLASS("_TtC20CustomerIOSFramework19TransactionDropDown")
@interface TransactionDropDown : UIView
...
@interface TransactionDropDown (SWIFT_EXTENSION(CustomerIOSFramework))
...
@interface TransactionDropDown (SWIFT_EXTENSION(CustomerIOSFramework)) <UITableViewDataSource, UITableViewDelegate>
...
@interface UIBarButtonItem (SWIFT_EXTENSION(CustomerIOSFramework)) <AnchorView>
@property (nonatomic, readonly, strong) UIView * _Nonnull plainView;
@end
...
@interface UIView (SWIFT_EXTENSION(CustomerIOSFramework)) <AnchorView>
@property (nonatomic, readonly, strong) UIView * _Nonnull plainView;
@end
